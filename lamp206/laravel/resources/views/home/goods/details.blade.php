...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script type="text/javascript" src="/home/basic//home/js/jquery-1.7.min.js"></script>
	...
	<body>
		...
		<div class="am-container header">
			...
			<div class="nav-table">
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="/home/images/01.jpg"><img src="{{ $data['gpic'] }}" alt="细节展示放大镜特效" rel="{{ $data['gpic'] }}" class="jqzoom" /></a>
							</div>
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								...
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">1{{ $data['price'] }}</b></dd>									
								</li>
								<div class="clear"></div>
							</div>
							...
							<ul class="tm-ind-panel">
								<li class="tm-ind-item tm-ind-sellCount canClick">
									<div class="tm-indcon"><span class="tm-label">累计销量</span><span class="tm-count">{{ $data['ent'] }}</span></div>
								</li>
								<li class="tm-ind-item tm-ind-sumCount canClick">
									<div class="tm-indcon"><span class="tm-label"></span><span class="tm-count">6015</span></div>
								</li>
				...
				<!--优惠套装-->
				<div class="match">
					<div class="match-title">特价优惠</div>
